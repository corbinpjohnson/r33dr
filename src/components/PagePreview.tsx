...
const PagePreview: React.FC<PagePreviewProps> = ({
  ...
  if (page.previewImage) {
    ...
    return (
      <div ref={scrollRef} className={`flex-1 overflow-auto bg-white ${transitionCls} ${opacity}`}>
  ...
  return (
    <div
      ...
      className={`flex-1 overflow-auto p-12 bg-white text-slate-900 font-serif leading-relaxed prose prose-slate max-w-none ${transitionCls} ${opacity}`}
    />
  );
};
